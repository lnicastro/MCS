...
CONFIG_HEADER = $(top_builddir)/src/mcs_config.h
...
abs_builddir = /Users/nicastro/Soft/Devel/GitHub/MCS
abs_srcdir = /Users/nicastro/Soft/Devel/GitHub/MCS
...
#	make -C extra/dif  prepdist
#	make -C extra/myro prepdist
